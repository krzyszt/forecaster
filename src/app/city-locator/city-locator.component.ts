...
@Component({
  ...
  templateUrl: './city-locator.component.html',
  styleUrls: ['./city-locator.component.css']
})
export class CityLocatorComponent implements OnInit {
  ...
  public statesComplex: any[] = [
    ...
    {id: 51, name: 'Wyoming', region: 'West'}, {id: 52, name: 'London', region: 'UK'}];


  public constructor(private cityListService: CityListService) {
